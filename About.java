...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("notepad/icons/icon1.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("notepad/icon.png"));
